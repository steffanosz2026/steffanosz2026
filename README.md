...
Soy estudiante de la carrera **Tecnólogo en Informática (CURE/UTEC)**. Me apasiona la lógica de programación, el diseño de software y la arquitectura computacional. Mi enfoque está en escribir código limpio, eficiente y resolver problemas complejos mediante algoritmos bien estructurados.

1. 🛠️ Tecnologías y Herramientas
* **Lenguajes:** C / C++
* **Conceptos clave:** Programación estructurada, lógica secuencial, estructuras de datos, álgebra de Boole, control de versiones (Git).
